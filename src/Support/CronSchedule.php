...
class CronSchedule
{
     ...
     * @throws Exception
     */
    final public static function fromCronString($cronSpec = '* * * * * *', $language = 'en'): CronSchedule
    {
     ...
     * @throws Exception
     */
    private function cronInterpret($specification, $rangeMin, $rangeMax, $namedItems, $errorName): array
    {
    ...
    private function cronCreateItems($cronInterpreted): array
    {
        $items = [];
    ...
    private function dtAsString($arrDt): false|string
    {
        if ($arrDt === false) {
            return false;
        }
    ...
    final public function match($time = false): bool
    {
